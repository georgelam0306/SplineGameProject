...
namespace Catrillion.GameData.Cli;
...
public static class Program
{
    ...
    {
        Console.WriteLine("Catrillion.GameData.Cli - Binary file builder");
        Console.WriteLine();
    ...
    private static int Build(string[] args)
    {
        ...
        try
        {
            // Use the generated builder (emitted by GameDocDatabase.Generator into Catrillion.GameData.Schemas)
