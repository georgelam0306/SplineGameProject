...
public sealed class PauseMenu
{
    ...
    private const int DialogHeight = 310;  // Increased for Bug Report button
    ...
    public PauseMenuAction UpdateAndDraw()
    {
        ...
        // Bug Report button
        if (ImmediateModeUI.Button(buttonX, startY + (ButtonHeight + ButtonSpacing) * 3, ButtonWidth, ButtonHeight, "Bug Report"))
        {
            return PauseMenuAction.BugReport;
        }
