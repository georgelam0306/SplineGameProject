...
public static class GameDataManagerFactory
{
    ...
    private static string? FindSourceDataPath()
    {
        ...
        while (dir != null)
        {
            // Check if this is the workspace root (has Catrillion.GameData/Data)
            var sourcePath = Path.Combine(dir.FullName, "Catrillion.GameData", "Data");
