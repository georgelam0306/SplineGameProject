...
namespace BaseTemplate.GameData.Cli;
...
public static class Program
{
    ...
    {
        Console.WriteLine("BaseTemplate.GameData.Cli - Binary file builder");
        Console.WriteLine();
    ...
    private static int Build(string[] args)
    {
        ...
        try
        {
            // Use the generated builder (emitted by GameDocDatabase.Generator into BaseTemplate.GameData.Schemas)
