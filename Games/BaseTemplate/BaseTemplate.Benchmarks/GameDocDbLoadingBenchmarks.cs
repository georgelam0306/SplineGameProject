...
public class GameDocDbLoadingBenchmarks
{
    ...
    public void Setup()
    {
        ...
        var possiblePaths = new[]
        {
            ...
            Path.Combine(baseDir, "..", "..", "..", "..", "BaseTemplate.GameData", "Data", "GameData.bin"),
            Path.Combine(baseDir, "..", "..", "..", "..", "Outputs", "BaseTemplate", "bin", "Debug", "net9.0", "GameData.bin"),
            Path.Combine(baseDir, "..", "..", "..", "..", "Outputs", "BaseTemplate", "bin", "Release", "net9.0", "GameData.bin"),
        };
        ...
        {
            // Build it if needed
            _jsonDataPath = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "..", "..", "BaseTemplate.GameData", "Data"));
