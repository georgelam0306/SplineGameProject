...
using BaseTemplate.Simulation.Systems.Pickup;
using BaseTemplate.Simulation.Utilities;
using SimTable;

namespace BaseTemplate.Tests.Simulation.Systems;
...
public class SuperPickupSystemDeterminismTests : IDisposable
{
    ...
    public void SnapshotRestore_WithRecycledStableIds_WorksCorrectly()
    {
        ...
        var snapshot = new BaseTemplate.Infrastructure.Rollback.WorldSnapshot(_world);
