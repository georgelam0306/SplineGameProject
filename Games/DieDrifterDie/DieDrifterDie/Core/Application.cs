...
using Raylib_cs;
using Serilog;
using DieDrifterDie; // For AotSchema generated class
...
public partial class Program
{
    ...
    {
        DieDrifterDie.GameApp.Core.Logging.Initialize();
    ...
    private static void RunGame(string[] args)
    {
        ...
        Raylib.InitWindow(_windowWidth, _windowHeight, "DieDrifterDie");
        ...
        finally
        {
            ...
            DieDrifterDie.GameApp.Core.Logging.Shutdown();
            Raylib.CloseWindow();
        }
    }
