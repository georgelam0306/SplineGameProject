...
namespace DieDrifterDie.GameData;
...
public static class GameDataManagerFactory
{
    ...
    private static string? FindSourceDataPath()
    {
        ...
        while (dir != null)
        {
            // Check if this is the workspace root (has DieDrifterDie.GameData/Data)
            var sourcePath = Path.Combine(dir.FullName, "DieDrifterDie.GameData", "Data");
