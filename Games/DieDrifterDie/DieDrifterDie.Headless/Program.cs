...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        if (args.Length < 1)
        {
            Console.WriteLine("Usage: DieDrifterDie.Headless <replay-file> [iterations|--rollback]");
            Console.WriteLine();
            ...
            Console.WriteLine("  DieDrifterDie.Headless Logs/replay.bin           # 3 iterations");
            Console.WriteLine("  DieDrifterDie.Headless Logs/replay.bin 10        # 10 iterations");
            Console.WriteLine("  DieDrifterDie.Headless Logs/replay.bin --rollback  # rollback test");
