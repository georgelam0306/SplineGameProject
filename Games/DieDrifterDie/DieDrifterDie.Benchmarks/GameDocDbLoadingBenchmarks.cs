...
public class GameDocDbLoadingBenchmarks
{
    ...
    public void Setup()
    {
        ...
        var possiblePaths = new[]
        {
            ...
            Path.Combine(baseDir, "..", "..", "..", "..", "DieDrifterDie.GameData", "Data", "GameData.bin"),
            Path.Combine(baseDir, "..", "..", "..", "..", "Outputs", "DieDrifterDie", "bin", "Debug", "net9.0", "GameData.bin"),
            Path.Combine(baseDir, "..", "..", "..", "..", "Outputs", "DieDrifterDie", "bin", "Release", "net9.0", "GameData.bin"),
        };
        ...
        {
            // Build it if needed
            _jsonDataPath = Path.GetFullPath(Path.Combine(baseDir, "..", "..", "..", "..", "DieDrifterDie.GameData", "Data"));
