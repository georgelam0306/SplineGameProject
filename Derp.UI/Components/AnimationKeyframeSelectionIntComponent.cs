...
[Pooled(SoA = true, GenerateStableId = true, PoolId = 231)]
public partial struct AnimationKeyframeSelectionIntComponent
{
    ...
    [Column(Storage = ColumnStorage.Sidecar)]
    [Property(Name = "Value", Group = "Keyframe", Order = 1, Kind = PropertyKind.Int)]
    public int Value;
